...
class _CartScreenState extends State<CartScreen> {
  ...
  buildCartRow(CartProduct cartProduct, List<AddAddonsDemo> addons) {
    ...
    if (cartProduct.extras_price != null && cartProduct.extras_price != "" && double.parse(cartProduct.extras_price!) != 0.0) {
      addOnValDoule += double.parse(cartProduct.extras_price!) * cartProduct.quantity;
    }
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      "(${amountShow(amount: addOnValDoule.toString())})",
                      maxLines: 2,
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.start,
                      style: TextStyle(fontSize: 14, fontFamily: "Poppinsm", color: Color(COLOR_PRIMARY)),
  ...
  Widget buildTotalRow(List<CartProduct> data, List<AddAddonsDemo> lstExtras, String vendorID) {
    ...
    if (vendorModel != null) {
      if (vendorModel!.specialDiscountEnable && specialDiscountOffer) {
        ...
        Container(
          ...
          child: Column(
            children: [
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                            ...
                            fontSize: selctedOrderTypeValue == "Delivery" ? _font : 14),
                      ),
                    ],
                  )),
              const Divider(
              ...
              Visibility(
                visible: vendorModel != null ? vendorModel!.specialDiscountEnable && specialDiscountOffer : false,
                child: Column(
                  children: [
                    Container(
                        padding: const EdgeInsets.symmetric(horizontal: 20, vertical: 5),
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              amountShow(
                                  amount:
                                      calculateTax(amount: (double.parse(subTotal.toString()) - discountAmount - specialDiscountAmount).toString(), taxModel: taxModel).toString()),
                              style: TextStyle(fontFamily: "Poppinsm", color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(0xff333333), fontSize: _font),
                            ),
                          ],
                        ),
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      textAlign: TextAlign.start,
                      style: TextStyle(
                          fontFamily: "Poppinsm", fontWeight: FontWeight.bold, color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(0xff333333), fontSize: 15),
                    ),
                    Text(
