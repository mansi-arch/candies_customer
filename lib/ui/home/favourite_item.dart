...
import 'package:foodie_customer/services/show_toast_dialog.dart';
  ...
  Widget buildAllStoreData(ProductModel productModel, int index) {
    ...
    return GestureDetector(
      onTap: () async {
        ...
        if (vendorModel!.zoneId == selectedZone!.id) {
          push(
            context,
                          ...
                          onTap: () {
                            setState(() {
                              FavouriteItemModel favouriteModel =
                                  FavouriteItemModel(productId: productModel.id, storeId: productModel.vendorID, userId: MyAppState.currentUser!.userID);
