...
class _ViewAllCategoryProductScreenState extends State<ViewAllCategoryProductScreen> {
  ...
  Widget buildVendorItemData(BuildContext context, VendorModel vendorModel) {
    double distanceInMeters =
        Geolocator.distanceBetween(vendorModel.latitude, vendorModel.longitude, MyAppState.selectedPosotion.location!.latitude, MyAppState.selectedPosotion.location!.longitude);
                        ...
                        children: [
                          ...
                          Expanded(
                            child: Text(vendorModel.location,
                                    maxLines: 1, style: TextStyle(fontFamily: "Poppinsm", color: isDarkMode(context) ? Colors.white : Colors.black.withOpacity(0.60)))
                                .tr(),
                          ),
                        ],
                      ),
