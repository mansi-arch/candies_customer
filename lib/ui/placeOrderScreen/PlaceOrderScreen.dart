...
class _PlaceOrderScreenState extends State<PlaceOrderScreen> {
  ...
  animateOut() async {
    ...
    if (widget.orderModel.scheduleTime != null) {
      await SendNotification.sendFcmMessage(scheduleOrder, widget.orderModel.vendor.fcmToken, {});
    } else {
      await SendNotification.sendFcmMessage(orderPlaced, widget.orderModel.vendor.fcmToken, {});
    }
