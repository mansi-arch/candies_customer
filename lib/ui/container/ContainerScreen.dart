...
class ContainerScreen extends StatefulWidget {
  ...
  const ContainerScreen({super.key, this.user, this.currentWidget, this.appBarTitle, this.drawerSelection});
...
class _ContainerScreen extends State<ContainerScreen> {
      ...
      if (value.exists) {
        setState(() {
          ...
          if (isZoneAvailable == false) {
            _currentWidget = ZoneNotAvailable();
          } else if (widget.currentWidget != null) {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        if (!(_currentWidget is HomeScreen) && !(_currentWidget is HomeScreenTwo)) {
          setState(() {
            _drawerSelection = DrawerSelection.Home;
          ...
          builder: (context, user, _) {
            return Scaffold(
              ...
              appBar: AppBar(
                ...
                actions: isZoneAvailable == false
                    ? []
                    : _drawerSelection == DrawerSelection.Wallet || _drawerSelection == DrawerSelection.MyBooking
                        ? []
                        : _drawerSelection == DrawerSelection.dineIn
                            ? [
                                IconButton(
