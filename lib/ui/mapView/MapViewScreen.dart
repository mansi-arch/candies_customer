...
class _MapViewScreenState extends State<MapViewScreen> {
  ...
  void initState() {
    ...
    fireStoreUtils.getRestaurantNearBy().whenComplete(() {
      ...
      if (mounted) {
        setState(() {
          _mapFuture = fireStoreUtils.getAllRestaurants().asBroadcastStream();
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    SizedBox(width: 5),
                                                    Text(
                                                      vendors[index].reviewsCount != 0
                                                          ? '${(vendors[index].reviewsSum / vendors[index].reviewsCount).toStringAsFixed(1)}'
                                                          : 0.toString(),
                                                      style: TextStyle(
                                                        fontFamily: 'Poppinsm',
                                                        color: isDarkMode(context) ? Colors.white70 : Colors.black,
                                                    ...
                                                    SizedBox(width: 4),
                                                    Text(
                                                      "(${vendors[index].reviewsCount.toString()})",
                                                      style: TextStyle(
                                                        fontFamily: 'Poppinsm',
                                                        color: isDarkMode(context) ? Colors.white70 : Colors.black,
                                                      ),
  ...
  Future<void> getTempLocation() async {
    ...
    if (MyAppState.currentUser == null && MyAppState.selectedPosotion.location!.longitude != 0 && MyAppState.selectedPosotion.location!.latitude != 0) {
