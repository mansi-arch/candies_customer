                    ...
                    setState(() {
                      ...
                      if (contain.isNotEmpty) {
                        FavouriteItemModel favouriteModel =
                            FavouriteItemModel(productId: widget.productModel.id, storeId: widget.vendorModel.id, userId: MyAppState.currentUser!.userID);
                                      ...
                                      : TextButton.icon(
                                          onPressed: () {
                                            if (MyAppState.currentUser == null) {
                                              ...
                                              setState(() {
                                                if (variants!.where((element) => element.variantSku == selectedVariants.join('-')).isNotEmpty) {
                                                  if (int.parse(variants!.where((element) => element.variantSku == selectedVariants.join('-')).first.variantQuantity.toString()) >=
                                                          1 ||
                                                      int.parse(variants!.where((element) => element.variantSku == selectedVariants.join('-')).first.variantQuantity.toString()) ==
                                                          -1) {
                                            ...
                                            IconButton(
                                                onPressed: () {
                                                  setState(() {
                                                    if (variants!.where((element) => element.variantSku == selectedVariants.join('-')).isNotEmpty) {
                                                      if (int.parse(
                                                                  variants!.where((element) => element.variantSku == selectedVariants.join('-')).first.variantQuantity.toString()) >
                                                              productQnt ||
                                                          int.parse(variants!
                                ...
                                child: ListView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    if (productModel.itemAttributes != null) {
                                      ...
                                      if (productModel.itemAttributes!.variants!.where((element) => element.variantSku == selectedVariants.join('-')).isNotEmpty) {
                                        price = productCommissionPrice(productModel.itemAttributes!.variants!.where((element) => element.variantSku == selectedVariants.join('-')).first.variantPrice ?? '0');
