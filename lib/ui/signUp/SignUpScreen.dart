...
class _SignUpState extends State<SignUpScreen> {
  ...
  _signUpWithEmailAndPassword() async {
    await showProgress( "Creating new account, Please wait...".tr(), false);
    dynamic result =
        await FireStoreUtils.firebaseSignUpWithEmailAndPassword(email!.trim(), password!.trim(), _image, firstName!, lastName!, mobile!, context, referralCode.toString());
    await hideProgress();
