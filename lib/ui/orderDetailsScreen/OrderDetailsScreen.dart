...
import 'package:foodie_customer/ui/orderDetailsScreen/order_tracking_screen.dart';
                            ...
                            : Padding(
                                ...
                                child: Wrap(
                                  ...
                                  children: List.generate(
                                    ...
                                    (i) {
                                      return _buildChip(
                                          "${variantIno.variantOptions!.keys.elementAt(i)} : ${variantIno.variantOptions![variantIno.variantOptions!.keys.elementAt(i)]}", i);
                                    },
                                  ).toList(),
                                ),
                              ),
                              ...
                              : Align(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Text(
                                        "${amountShow(amount: (double.parse(widget.orderModel.products[index].extras_price.toString()) * double.parse(widget.orderModel.products[index].quantity.toString())).toString())}",
                                        maxLines: 2,
                          ...
                          children: [
                            Expanded(
                              child: InkWell(
                                ...
                                onTap: () async {
                                  showProgress('Please wait....'.tr(), false);
                                  ...
                                  if (productModel!.itemAttributes != null) {
                                    if (productModel!.itemAttributes!.variants!.where((element) => element.variantSku == variantIno!.variantSku).isNotEmpty) {
                                      if (int.parse(productModel!.itemAttributes!.variants!
                                              .where((element) => element.variantSku == variantIno!.variantSku)
                                              .first
                                              .variantQuantity
                                              .toString()) >=
                                    ...
                                    if (productModel!.quantity >= widget.orderModel.products[index].quantity || productModel!.quantity == -1) {
                                      final bool _productIsInList = cartProducts.any((product) =>
                                          product.id == productModel!.id + "~" + (productModel!.variantInfo != null ? productModel!.variantInfo!.variantId.toString() : ""));
                                      if (_productIsInList) {
