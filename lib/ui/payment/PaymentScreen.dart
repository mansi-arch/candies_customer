...
class PaymentScreenState extends State<PaymentScreen> {
              ...
              children: [
                ...
                StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                    ...
                    builder: (context, AsyncSnapshot<DocumentSnapshot<Map<String, dynamic>>> asyncSnapshot) {
                      ...
                      walletBalanceError = double.parse(userData.walletAmount.toString()) < double.parse(widget.total.toString()) ? true : false;
                      return Column(
                        children: [
                          CheckboxListTile(
  ...
  placeOrder(BuildContext buildContext, {String? oid}) async {
    ...
    OrderModel orderModel = OrderModel(
      ...
      adminCommission: adminCommissionModel != null && adminCommissionModel!.isEnabled == true ? adminCommissionModel!.adminCommission.toString() : "0",
      adminCommissionType: adminCommissionModel != null && adminCommissionModel!.isEnabled == true ? adminCommissionModel!.adminCommissionType.toString() : "",
      takeAway: true,
            ...
            if (productModel.itemAttributes!.variants![j].variantId == tempProduc[i].id.split('~').last) {
              if (productModel.itemAttributes!.variants![j].variantQuantity != "-1") {
                productModel.itemAttributes!.variants![j].variantQuantity =
                    (int.parse(productModel.itemAttributes!.variants![j].variantQuantity.toString()) - tempProduc[i].quantity).toString();
              }
            }
          }
        } else {
