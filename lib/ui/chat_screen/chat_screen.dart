...
class _ChatScreensState extends State<ChatScreens> {
              ...
              child: GestureDetector(
                ...
                child: PaginateFirestore(
                  ...
                  query: FirebaseFirestore.instance
                      .collection(widget.chatType == "Driver" ? 'chat_driver' : 'chat_restaurant')
                      .doc(widget.orderId)
                      .collection("thread")
  ...
  _sendMessage(String message, Url? url, String videoThumbnail, String messageType) async {
    ...
    await SendNotification.sendChatFcmMessage(widget.customerName.toString(), conversationModel.message.toString(), widget.token.toString(),{});
  }
