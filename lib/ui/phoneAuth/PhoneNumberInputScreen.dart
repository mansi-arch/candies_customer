...
class _PhoneNumberInputScreenState extends State<PhoneNumberInputScreen> {
  ...
  void _submitCode(String code) async {
    await showProgress( widget.login ? "Logging in...".tr() : "Signing up...".tr(), false);
    try {
      if (_verificationID != null) {
        dynamic result = await FireStoreUtils.firebaseSubmitPhoneNumberCode(_verificationID!, code, _phoneNumber!, context,
  ...
  _submitPhoneNumber(String phoneNumber) async {
    //send code
    await showProgress( "Sending code...".tr(), true);
