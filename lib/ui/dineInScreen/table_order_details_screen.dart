                                  ...
                                  Visibility(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Opacity(
                                        opacity: 0.7,
                                        child: Text(
                                          "Your request is in processing. ".tr() + "it may take up to 3 mins.".tr(),
                        ...
                        child: Column(
                          children: [
                            ...
                            buildDetails(
                              ...
                              title: "Discount",
                              value: "${widget.bookTableModel.discount} ${widget.bookTableModel.discountType == "amount" ? currencyModel!.symbol : "%"} off",
                            ),
                          ],
                        ),
                      )
