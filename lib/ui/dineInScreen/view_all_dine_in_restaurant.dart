...
class _ViewAllDineInRestaurantState extends State<ViewAllDineInRestaurant> {
  ...
  getProducts() async {
    ...
    var collectionReference = FireStoreUtils.firestore.collection(VENDORS).where("zoneId", isEqualTo: selectedZone!.id.toString()).where("enabledDiveInFuture", isEqualTo: true);
    ...
    Stream<List<DocumentSnapshot>> stream =
        GeoFlutterFire().collection(collectionRef: collectionReference).within(center: center, radius: radiusValue, field: field, strictMode: true);
