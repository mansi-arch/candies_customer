...
import 'package:foodie_customer/services/send_notification.dart';
        ...
        widget.vendorModel.specialDiscount.forEach((element) {
          if (day == element.day.toString()) {
            if (element.timeslot!.isNotEmpty) {
              Timeslot employeeWithMaxSalary =
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [
                        Padding(
                          ...
                          child: Text(widget.vendorModel.title,
                              maxLines: 2,
                              style: TextStyle(fontFamily: "Poppinsm", fontSize: 18, letterSpacing: 0.5, color: isDarkMode(context) ? Color(0xffFFFFFF) : Color(0xff2A2A2A))),
                        ),
                        resttiming()
                      ]),
                    ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Column(children: [
                                  ...
                                  Text(
                                    widget.vendorModel.restaurantCost == 0 ? "" : '${amountShow(amount: widget.vendorModel.restaurantCost.toString())} for two',
                                    // "${minute.toDouble()} min",
                                ...
                                Column(children: [
                                  ...
                                  Text(
                                    widget.vendorModel.reviewsCount == 0
                                        ? '0' + " " + 'Rate'.tr()
                                        : ' ${double.parse((widget.vendorModel.reviewsSum / widget.vendorModel.reviewsCount).toStringAsFixed(1))}' + ' Rate'.tr(),
                                    style: TextStyle(fontFamily: "Poppinssr", letterSpacing: 0.5, color: isDarkMode(context) ? Colors.white60 : Color(0xff565764)),
                                  ).tr()
                                ]),
                                InkWell(
                      ...
                      InkWell(
                          ...
                          child: Container(
                              ...
                              decoration: BoxDecoration(
                                  ...
                                  boxShadow: [
                                    BoxShadow(
                                        color: isDarkMode(context) ? Colors.grey.shade700 : Colors.grey.shade300, blurRadius: 3.0, spreadRadius: 0.6, offset: Offset(0.1, 0.5)),
                                  ],
                                  color: isDarkMode(context) ? Color(DARK_CARD_BG_COLOR) : Colors.white),
                              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                Container(
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text("In ${hour.toString().padLeft(2, "0")}h ${minute.toStringAsFixed(0).padLeft(2, "0")}" + "minute".tr(),
                                        style: TextStyle(
                                          fontFamily: "Poppinsr",
                                        )).tr()
                                  ],
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("Menus".tr(), style: TextStyle(fontSize: 16, fontFamily: "Poppinsm")),
                                    ...
                                    children: [
                                      ...
                                      Text(
                                          widget.vendorModel.restaurantCost == 0
                                              ...
                                              : "Cost for two".tr() + " - ${amountShow(amount: widget.vendorModel.restaurantCost.toString())} " + "(Approx)".tr(),
                                          style: TextStyle(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Cuisines".tr(), style: TextStyle(color: isDarkMode(context) ? Colors.white : Color(0xFF000000), fontSize: 16, fontFamily: "Poppinsm")),
                              ],
                            ),
                          ),
                          Padding(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text("valid till".tr() + " Nov 31,2022", style: TextStyle(fontFamily: "Poppins", letterSpacing: 0.5))
                    ],
                  ),
                ],
              )),
                                                  ...
                                                  child: Column(
                                                    children: [
                                                      ...
                                                      timeSlotList[index].discountType == "amount"
                                                          ? Text(
                                                              amountShow(amount: timeSlotList[index].discountPer!),
                                                              style: TextStyle(
                                                                fontSize: 16,
                                                                color: isSelected ? Colors.white : Colors.black54,
                                                              ),
                      ...
                      Padding(
                        ...
                        child: MaterialButton(
                          ...
                          onPressed: () async {
                            ...
                            showProgress( 'Sending Table Request...'.tr(), false);
                            ...
                            await SendNotification.sendFcmMessage(dineInPlaced, widget.vendorModel.fcmToken,{});
